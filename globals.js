...
window.addEventListener("load", () => {
    document.getElementById("againstBtns").style.display = "none";
    document.getElementById("rotateButton").style.display = "none";
    document.getElementById("AIBtns").style.display = "none";
...
function startButtonRegister() {
    document.getElementById("startButton").addEventListener('click', e => {
        if (g_mode == "unstarted") {
            ...
            //g_mode = "start";
            g_mode = "menu1";
            document.getElementById("againstBtns").style.display = "initial";
            document.getElementById("numShipsLabel").style.display = "none";
            document.getElementById("number_of_ships").style.display = "none";
...
function AIBtnRegister() {
    g_mode = "menu2";
    document.getElementById("againstBtns").style.display = "none";
    document.getElementById("AIBtns").style.display = "initial";
}

function easyBtnRegister() {
    g_opponent = 'easy';
    g_mode = 'start';
    document.getElementById("AIBtns").style.display = "none";
    document.getElementById("rotateButton").style.display = "initial";
