...
function renderMenu1(context, canvas) {
    ...
    context.beginPath();
    context.rect(20, 20, 215, 100);
    context.stroke();

    context.beginPath();
    context.rect(245, 20, 215, 100);
    context.stroke();

    context.font = "20px 'Roboto', sans-serif";
    context.fillText("Play Against Human", 25, 45);
    context.fillText("Play Against Computer", 250, 45);*/
}
...
{
        context.font = "bold 40px 'Roboto Slab', serif";
...
function switchTurn(context, canvas, nextPlayer) {
    ...
    clearScreen(context);
    context.fillStyle = "#8B2F2D";
    context.fillRect(0, 0, canvas.width, canvas.height);
    context.font = "bold 40px 'Roboto Slab', serif";
    context.fillStyle = "#80D5F6";
    ...
    //displays hit, miss, or sunk message
    if (g_numSwitch > 1 || (g_numSwitch > 0 && g_opponent != "human")) {
        if (g_hit == 0) {
...
function gameOver(context, canvas, winner) {
    ...
    if (winner == 1) {
        ...
        context.drawImage(img_p1Win, /*(canvas.width / 2) - (3 * p1width), canvas.height / 4*/ 0, 0, p1width /* * 6*/, p1height /* * 6*/);
    } else if (winner == 2) {
        
        context.drawImage(img_p2Win, 0, 0, p2width, p2height);
    }
...
function drawGrid(context, grid) {
    ...
    for (let i = 1; i < 10; i++) {
        ...
        context.font = "bold 20px 'Roboto Slab', serif";
        context.fillStyle = "#121f26";
